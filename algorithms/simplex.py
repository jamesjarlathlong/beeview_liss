...
if __name__ == '__main__':
    ...
    ineq_left = [[2,   4   ],
                [0.5, 0.25],
                 [2,   2.5 ]]
    ineq_right = [440, 65, 320]
    eq_left = [[3,0]]
    eq_right = [16]
    resolution, sol = linsolve(objective, ineq_left = ineq_left, ineq_right = ineq_right, eq_left = eq_left, eq_right = eq_right  )
    print('soltuon: ', sol)